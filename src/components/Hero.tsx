    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden" id="home">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-muted border border-border text-sm font-medium mb-6">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl">
              I build modern, responsive, and user-friendly web applications. I am passionate about solving real-world problems through technology and continuously improving my development skills.
            </p>
      ...
      <div className="absolute top-1/4 right-0 -z-10 translate-x-1/3 opacity-[0.08] dark:opacity-20 pointer-events-none blur-[100px]">
